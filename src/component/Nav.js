  ...
  return <Nav>
    <div className={menuIcon ? "navbar active" : "navbar"}>
      <ul className='navbar-lists'>
        ...
        <li>
          <NavLink to="/about" onClick={() => setMenuIcon(false)} className="navbar-link home-link">About</NavLink>
        </li>
        <li>
          <NavLink to="/product" onClick={() => setMenuIcon(false)} className="navbar-link home-link">Products</NavLink>
        </li>
        <li>
          <NavLink to="/contact" onClick={() => setMenuIcon(false)} className="navbar-link home-link">Contact</NavLink>
        </li>
